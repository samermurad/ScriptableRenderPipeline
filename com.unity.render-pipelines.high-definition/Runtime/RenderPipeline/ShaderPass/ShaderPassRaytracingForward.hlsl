...
void ClosestHitForward(inout RayIntersection rayIntersection : SV_RayPayload, AttributeData attributeData : SV_IntersectionAttributes)
{
    ...
    LightLoop(viewWS, posInput, preLightData, bsdfData, builtinData, reflectedWeight, reffractedWeight, reflected, transmitted, diffuseLighting, specularLighting);
