...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    {
        internal static void ReadShadowResult(RenderGraphBuilder builder, ShadowResult shadowResult)
        {
            if (shadowResult.punctualShadowResult.IsValid())
                builder.ReadTexture(shadowResult.punctualShadowResult);
            if (shadowResult.directionalShadowResult.IsValid())
                builder.ReadTexture(shadowResult.directionalShadowResult);
            if (shadowResult.areaShadowResult.IsValid())
                builder.ReadTexture(shadowResult.areaShadowResult);
        }
